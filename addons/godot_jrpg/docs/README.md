...
- [1. Core Philosophy and Base Architecture](#1-core-philosophy-and-base-architecture)
  - [1.1. Separation of Concerns (Adapted MVC)](#11-separation-of-concerns-adapted-mvc)
  - [1.2. Data-Driven Design](#12-data-driven-design)
  - [1.3. Stateless Recalculation](#13-stateless-recalculation)
- [2. Battle Engine and State Machine](#2-battle-engine-and-state-machine)
  - [2.1. The State Pattern and Battle Phases](#21-the-state-pattern-and-battle-phases)
  - [2.2. Action Pool](#22-action-pool)
  - [2.3. Turn Lifecycle (Core Loop)](#23-turn-lifecycle-core-loop)
- [3. Input and Controller System](#3-input-and-controller-system)
  - [3.1. The Command Pattern (`BattleInput`)](#31-the-command-pattern-battleinput)
  - [3.2. Actors, Controllers, and "Brain"](#32-actors-controllers-and-brain)
  - [3.3. Practical Advantages and Headless Execution](#33-practical-advantages-and-headless-execution)
- [4. Attribute System and Modifiers](#4-attribute-system-and-modifiers)
  - [4.1. The Stateless Recalculation Principle](#41-the-stateless-recalculation-principle)
  - [4.2. Dynamic Source Collection](#42-dynamic-source-collection)
  - [4.3. Dynamic (On-Demand) Evaluation and Unified List](#43-dynamic-on-demand-evaluation-and-unified-list)
  - [4.4. Cumulative Multiplication (Balancing)](#44-cumulative-multiplication-balancing)
  - [4.5. Read Facades](#45-read-facades)
  - [4.6. References](#46-references)
- [5. Damage Pipeline and Target Routing](#5-damage-pipeline-and-target-routing)
  - [5.1. The Damage Calculation Pipeline (`DamageCalculator`)](#51-the-damage-calculation-pipeline-damagecalculator)
  - [5.2. Data-Driven Target Routing](#52-data-driven-target-routing)
  - [5.3. Application Responsibility (Effective MVC Pattern)](#53-application-responsibility-effective-mvc-pattern)
- [6. Global Systems](#6-global-systems)
  - [6.1. Global State Manager (`GameManager`)](#61-global-state-manager-gamemanager)
  - [6.2. Stack-Based Navigation (`MenuManager`)](#62-stack-based-navigation-menumanager)
  - [6.3. Data Persistence (`SaveState` and Load)](#63-data-persistence-savestate-and-load)
- [7. Stats System and Extensibility](#7-stats-system-and-extensibility)
  - [7.1. Logic and Presentation Separation (Display Names)](#71-logic-and-presentation-separation-display-names)
  - [7.2. Extensibility: Creating New Stats](#72-extensibility-creating-new-stats)
  - [7.3. Dynamic Formulas and New Mechanics](#73-dynamic-formulas-and-new-mechanics)
  - [7.4. Performance and Cache System (Dirty Flag)](#74-performance-and-cache-system-dirty-flag)
  - [7.5. Stat Evolution and Growth (`StatGrowth`)](#75-stat-evolution-and-growth-statgrowth)
- [8. Item, Equipment, and Skill System](#8-item-equipment-and-skill-system)
  - [8.1. Flexible Item Anatomy](#81-flexible-item-anatomy)
  - [8.2. Equipment as Trait Injectors](#82-equipment-as-trait-injectors)
  - [8.3. Skills and Formulas](#83-skills-and-formulas)
  - [8.4. Effective Delegation (Object Intelligence)](#84-effective-delegation-object-intelligence)
  - [8.5. Equipment Slot System](#85-equipment-slot-system)
  - [8.6. Customization vs. Creating New Slots](#86-customization-vs-creating-new-slots)
- [9. Status System (Buffs, Debuffs, and Abnormal States)](#9-status-system-buffs-debuffs-and-abnormal-states)
  - [9.1. Hybrid Nature of Status](#91-hybrid-nature-of-status)
  - [9.2. Application via Effects](#92-application-via-effects)
  - [9.3. The Magic of Temporary Recalculation](#93-the-magic-of-temporary-recalculation)
  - [9.4. Lifecycle and Upkeep (`BattlePhaseUpkeep`)](#94-lifecycle-and-upkeep-battlephaseupkeep)
  - [9.5. Conflict Resolution and Immunities](#95-conflict-resolution-and-immunities)
- [10. Event and Command System](#10-event-and-command-system)
  - [10.1. The Atomic Unit: `Command`](#101-the-atomic-unit-command)
  - [10.2. The Aggregator: `CommandList`](#102-the-aggregator-commandlist)
  - [10.3. The Orchestrator: `EventRunner` (Autoload)](#103-the-orchestrator-eventrunner-autoload)
  - [10.4. Trigger Versatility (Maps and Battles)](#104-trigger-versatility-maps-and-battles)
  - [10.5. Examples of Implemented Commands](#105-examples-of-implemented-commands)
  - [10.6. World State Variables (Switches)](#106-world-state-variables-switches)
- [11. Integrations and Third-Party Tools](#11-integrations-and-third-party-tools)
  - [11.1. Dialogue System (Dialogue Manager)](#111-dialogue-system-dialogue-manager)
  - [11.2. Cinematography and Transitions (Phantom Camera)](#112-cinematography-and-transitions-phantom-camera)
